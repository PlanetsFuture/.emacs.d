    ...
    (pretty-hydra-define toggles-hydra (:title (pretty-hydra-title "Toggles" 'faicon "toggle-on" :v-adjust -0.1)
      ...
      ("Basic"
       ...
       (("t a" (danny-load-theme 'auto) "auto"
        ...
        ("t i" (danny-load-theme 'classic) "classic"
         :toggle (danny-theme-enable-p 'classic) :exit t)
        ...
        ("t o" (ivy-read "Load custom theme: "
         ...
         :exit t))
       "Package Archive"
       (("p m" (danny-set-package-archives 'melpa t)
         "melpa" :toggle (eq danny-package-archives 'melpa) :exit t)
        ;("p c" (danny-set-package-archives 'emacs-china t)
        ; "emacs china" :toggle (eq danny-package-archives 'emacs-china) :exit t)
        ("p n" (danny-set-package-archives 'netease t)
         "netease" :toggle (eq danny-package-archives 'netease) :exit t)
        ("p s" (danny-set-package-archives 'ustc t)
         "ustc" :toggle (eq danny-package-archives 'ustc) :exit t)
        ("p t" (danny-set-package-archives 'tencent t)
         "tencent" :toggle (eq danny-package-archives 'tencent) :exit t)
        ("p u" (danny-set-package-archives 'tuna t)
         "tuna" :toggle (eq danny-package-archives 'tuna) :exit t)
        ("p T" (danny-test-package-archives) "speed test" :exit t))))))
