...
(use-package org
  ...
  :hook (((org-babel-after-execute org-mode) . org-redisplay-inline-images) ; display image
         (org-mode . (lambda ()
                       ...
                       (setq prettify-symbols-alist danny-prettify-org-symbols-alist)
...
prepended to the element after the #+HEADER: tag."
  ...
  (setq org-directory danny-org-directory
        ...
        org-agenda-files `(,danny-org-directory)
        org-todo-keywords
...
(when (and emacs/>=26p (executable-find "cc"))
  (use-package org-roam
    :diminish
    :custom (org-roam-directory (file-truename danny-org-directory))
