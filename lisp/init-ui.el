...
;; Logo
(setq fancy-splash-image danny-logo)

;; Title
(setq frame-title-format '("Danny Emacs - %b")
...
;; Theme
(if (danny-compatible-theme-p danny-theme)
    (progn
      ...
      (use-package doom-themes
        ...
        :init (danny-load-theme danny-theme t)
        :config
  ...
  (progn
    ...
    (danny-load-theme danny-theme t)))

;; Mode-line
(use-package doom-modeline
  :custom
  (doom-modeline-icon danny-icon)
...
(use-package all-the-icons
  :if (and danny-icon (display-graphic-p))
...
;; When `danny-prettify-symbols-alist' is `nil' use font supported ligatures
(use-package composite
  :ensure nil
  :unless danny-prettify-symbols-alist
