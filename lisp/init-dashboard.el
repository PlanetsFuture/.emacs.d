...
;; Dashboard
(unless emacs/>=25.3p (setq danny-dashboard nil))
(when danny-dashboard
  (use-package dashboard
    ...
    :init
    (setq dashboard-banner-logo-title "DANNY EMACS - Enjoy Programming & Writing"
          ...
          dashboard-set-file-icons danny-icon
          dashboard-set-heading-icons danny-icon
          ...
          dashboard-footer (format "Powered by Danny, %s" (format-time-string "%Y"))
          ...
          `(((,(when (icons-displayable-p)
              ...
              (lambda (&rest _) (browse-url danny-homepage)))
             (,(when (icons-displayable-p)
             ...
             (,(when (icons-displayable-p)
              ...
              "Update" "Update Danny Emacs"
              (lambda (&rest _) (danny-update)))
