...
;; (setq danny-proxy "127.0.0.1:1080")          ; Network proxy
;; (setq danny-server nil)                      ; Enable `server-mode' or not: t or nil
;; (setq danny-icon nil)                        ; Display icons or not: t or nil
;; (setq danny-package-archives 'emacs-china)   ; Package repo: melpa, emacs-china, netease, ustc, tencent or tuna
;; (setq danny-theme 'light)                    ; Color theme: auto, random, default, classic, colorful, dark, light, day or night
;; (setq danny-dashboard nil)                   ; Use dashboard at startup or not: t or nil
...
;; (setq danny-lsp-format-on-save-ignore-modes '(c-mode c++-mode)) ; Ignore format on save for some languages
;; (setq danny-chinese-calendar t)              ; Use Chinese calendar or not: t or nil
...
;; (setq danny-benchmark-init t)                ; Enable initialization benchmark or not: t or nil
